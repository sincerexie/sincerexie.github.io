...
<template>
  <svg t="1713012767816" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="14549" width="25" height="25">
    <path
      ...
      fill="#0e932e" p-id="14550"></path>
    <path d="M706.002 1.119v156.171c0 45.567 36.955 82.493 82.549 82.493h152.714l-235.263-238.662z" fill="#0e932e"
      p-id="14551"></path>
  </svg>
</template>
